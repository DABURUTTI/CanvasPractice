...
function () {
  ...
  _createClass(Point, [{
    key: "calcID",
    value: function calcID(x, y) {
      var px = 1;
      var py = 1; // for(var i = x; x > 0 ; i--){
      //   for(var j = y ; y > 0 ; j--){
      //   }
      // }
    ...
    value: function draw() {
      ...
      push(); //translate( map(this.x, 0, 100, -960, 960),  map(this.y, 0, 100, -540, 540),this.z);

      translate(this.x, this.y, this.z); //rotateY(frameCount * 0.1);
      //rotateZ(radians(90));
